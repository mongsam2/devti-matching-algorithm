...
with tab2:
    ...
    questions = [
        ...
        },
        {
            "dimension": "NS",
            "direction": "S",
            "text": "프로젝트의 배경이나 의도를 직접 이해하면서 따라가는 것보다, 내가 처리해야 할 구체적인 작업 목록과 마감 기한만 정해주고 일을 시킬 때 더 편안함을 느낀다.",
        },
        {
            "dimension": "FT",
            "direction": "T",
        ...
        },
        {
            "dimension": "IE",
            "direction": "E",
            "text": "혼자 조용히 코딩하거나 디자인 작업에 몰두할 때보다, 팀원들과 모여 프로그래밍이나 아이디에이션을 할 때 에너지가 솟는다.",
        },
        {
            "dimension": "NS",
            "direction": "S",
            "text": "검증되지 않은 최신 트렌드 기술을 도입하는 것보다, 레퍼런스가 많고 안정적인 기존 기술 스택을 사용하는 것을 선호한다.",
        },
        {
            "dimension": "FT",
            "direction": "T",
            "text": "팀 내 갈등 상황에서 누가 얼마나 마음이 상했는지보다, 누구의 말이 논리적으로 맞는지를 따지는 것이 중요하다.",
        },
        {
            "dimension": "PJ",
            "direction": "J",
            "text": "작업을 진행할 때, '디자인 레이어 이름'이나 '코드 변수명'을 대충 짓고 넘어가기보다는, 그때그때 규칙에 맞춰 깔끔하게 정리해놔야 직성이 풀린다.",
        },
        {
            "dimension": "IE",
            "direction": "I",
        ...
        },
        {
            "dimension": "NS",
            "direction": "S",
            "text": "동료의 결과물을 리뷰할 때, 전체적인 기획 의도나 흐름보다는 오타, 픽셀 1mm의 어긋남, 코드 들여쓰기 같은 디테일한 부분이 본능적으로 먼저 눈에 들어온다.",
        },
        {
            "dimension": "FT",
            "direction": "T",
        ...
        },
        {
            "dimension": "PJ",
            "direction": "J",
            "text": "회의 안건 없이 모여서 의식의 흐름대로 진행되는 자유로운 토론 시간은 비효율적이라고 느낀다.",
        },
        {
            "dimension": "IE",
            "direction": "I",
        ...
        },
        {
            "dimension": "NS",
            "direction": "N",
            "text": "개발 문서를 볼 때 예제 코드부터 복사해서 돌려보는 것보다, 원리나 개념부터 이해해야 직성이 풀린다.",
        },
        {
            "dimension": "FT",
            "direction": "F",
            "text": "팀원이 개인적인 사정으로 맡은 일을 못 했을 때, 대책을 세우기 전에 먼저 사정을 들어주고 공감해주는 편이다.",
        },
        {
            "dimension": "PJ",
            "direction": "P",
        ...
        },
        {
            "dimension": "NS",
            "direction": "S",
            "text": "새로운 기능을 개발하거나 디자인하려는데 참고할 만한 레퍼런스(유사 서비스, 예제 코드)가 하나도 없다면, 의욕이 생기기보단 막막함과 두려움을 먼저 느낀다.",
        },
        {
            "dimension": "FT",
            "direction": "T",
            "text": '칭찬을 들을 때 정말 고생 많으셨어요" 라는 위로의 말 보다 "코드가 정말 깔끔하네요", "디자인이 정말 깔끔하네요."처럼 능력을 인정해주는 말이 더 기분 좋다.',
        },
        {
            "dimension": "PJ",
            "direction": "J",
